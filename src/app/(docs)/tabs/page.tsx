      ...
      <div className="flex flex-col gap-16">
        <section className="flex flex-col gap-6">
          <div className="flex max-w-[632px] flex-col gap-2">
            ...
            <p className="font-inter text-base font-normal leading-[1.45] text-text-secondary">
              The tab component has an active and inactive state. The active tab
              uses primary text color and a 1px underline; inactive tabs use
              tertiary text color with no underline.
            </p>
          </div>
