...
type SidebarDocsTab = "preview" | "states" | "specs";
...
export default function SidebarButtonsPage() {
  const [activeTab, setActiveTab] = useState<SidebarDocsTab>("preview");
        ...
        {activeTab === "preview" && (
          <section className="flex flex-col gap-6">
            <div className="flex w-full flex-col gap-2">
              ...
              <p className="font-inter text-base font-normal leading-[1.45] text-text-secondary">
                Live sidebar button preview as it appears in the navigation
                rail.
              </p>
            </div>
